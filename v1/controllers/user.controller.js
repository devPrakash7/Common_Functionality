...
exports.signUp = async (req, res, next) => {
    try {
        ...
        // if (existingUser) return sendResponse(res, constants.WEB_STATUS_CODE.BAD_REQUEST, constants.STATUS_CODE.FAIL, 'USER.email_already_exist', {}, req.headers.lang);
...
//         const data = await userVerifyToken(userId, emailVerificationToken)
//         if (data == 1) {
//             // sendResponse(res, constants.WEB_STATUS_CODE.OK, constants.STATUS_CODE.SUCCESS, 'USER.account_verify_success', data, req.headers.lang)
//             message = req.flash(
//                 'success',
//                 `Your account has been verified successfully. Please click 'Continue' in the app to proceed.`
//             );
